...
_RELATIONSHIPS_FULL = {
    ...
    "AUTORA_DE": {"orientation": "UNDIRECTED"},
    "DESTINADA_A": {"orientation": "UNDIRECTED"},
    "BENEFICIOU": {"orientation": "UNDIRECTED"},
    "DOOU_PARA": {"orientation": "UNDIRECTED"},
    "EH_SERVIDOR": {"orientation": "UNDIRECTED"},
    "LOTADO_EM": {"orientation": "UNDIRECTED"},
    "CANDIDATO_EM": {"orientation": "UNDIRECTED"},
    "POSSUI_DIVIDA": {"orientation": "UNDIRECTED"},
    "RECEBEU_EMPRESTIMO": {"orientation": "UNDIRECTED"},
    "GASTOU": {"orientation": "UNDIRECTED"},
    "FORNECEU": {"orientation": "UNDIRECTED"},
    "DECLAROU_BEM": {"orientation": "UNDIRECTED"},
    "MESMO_QUE": {"orientation": "UNDIRECTED"},
    "PUBLICOU_LICITACAO": {"orientation": "UNDIRECTED"},
    "FIRMOU_CONTRATO": {"orientation": "UNDIRECTED"},
    "CONTRATOU": {"orientation": "UNDIRECTED"},
    "VINCULADO_A": {"orientation": "UNDIRECTED"},
    "DISPUTOU": {"orientation": "UNDIRECTED"},
    "DISPUTA_ITEM": {"orientation": "UNDIRECTED"},
    "PERTENCE_A": {"orientation": "UNDIRECTED"},
    "PAGO_POR": {"orientation": "UNDIRECTED"},
    "CELEBRADO_COM": {"orientation": "UNDIRECTED"},
    "REALIZA_ITEM": {"orientation": "UNDIRECTED"},
    "CELEBRA": {"orientation": "UNDIRECTED"},
    "REFERE_SE": {"orientation": "UNDIRECTED"},
    "LOCALIZADO_EM": {"orientation": "UNDIRECTED"},
}
